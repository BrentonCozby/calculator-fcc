...
export const SITE_NAME = 'calculator-fcc'
export const DESCRIPTION = 'Built from JavaScript, CSS, and HTML. A FreeCode Camp project.'
export const SITE_URL = 'd30l212gx59yk4.cloudfront.net'
